...
_commander().default.option('--version', 'Print CLI version').option('--projectRoot [string]', 'Path to the root of the project').option('--reactNativePath [string]', 'Path to React Native');
...
async function setupAndRun() {
  ...
  const root = _commander().default.projectRoot ? _path().default.resolve(_commander().default.projectRoot) : process.cwd();
  const reactNativePath = _commander().default.reactNativePath ? _path().default.resolve(_commander().default.reactNativePath) : (() => {
    try {
