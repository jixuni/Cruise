...
exports.default = exports.getDefaultConfig = void 0;
 ...
 */
var load = async function load(ctx, // $FlowFixMe - troubles with empty object being inexact
options = {}) {
  const defaultConfig = getDefaultConfig(ctx);
  const config = await (0, _metroConfig().loadConfig)(_objectSpread({
    cwd: ctx.root
